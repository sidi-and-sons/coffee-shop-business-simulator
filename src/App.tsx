...
const CoffeeShopSimulation = () => {
  ...
  const [hintType, setHintType] = useState("text"); // "text", "beans", "traffic"
  ...
  const determineHintType = () => {
    if (gameState.coffeeBeans <= 0) {
      return "beans";
    } else if (gameState.dailyCustomers < 130) {
      return "traffic";
    } else {
      return "text";
    }
  ...
  const handleHintClick = () => {
    const newHintType = determineHintType();
  ...
  const processMonth = () => {
    ...
    setGameState((prev) => {
      ...
      const staffCosts = newStaff * 2200;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-red-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span>Staff ({cashFlowData.expenses.staff} × $2,200):</span>
